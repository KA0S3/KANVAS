-- Migration: Fix function overloading for save_project and load_project
-- This drops the old functions to resolve parameter ambiguity

-- Drop all overloaded versions of save_project
DROP FUNCTION IF EXISTS save_project(UUID, JSONB, JSONB, JSONB, TEXT, TEXT, INTEGER);
DROP FUNCTION IF EXISTS save_project(UUID, TEXT, TEXT, JSONB, JSONB, JSONB, TEXT, TEXT, TEXT, TEXT, BOOLEAN, JSONB, INTEGER);
DROP FUNCTION IF EXISTS save_project(UUID, JSONB, JSONB, JSONB, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, BOOLEAN, JSONB, INTEGER);

-- Recreate save_project with cover columns in correct order
...
-- Drop all overloaded versions of load_project
DROP FUNCTION IF EXISTS load_project(UUID);

-- Recreate load_project to return cover columns
